...
if(navigator.geolocation){
    navigator.geolocation.getCurrentPosition(posicion=>{
        ...
        url = `http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=f65b392a123a22efa2c4b06fdc50651d`
    console.log(url)
        ...
        const getData = async()=>{
            ...
            <div id="container">
            <ul>
                <li>Porsentaje de nubes: ${data.clouds.all}</li>
                <li>Poblacion: ${data.name}</li>
